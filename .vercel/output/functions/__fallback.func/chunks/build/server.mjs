import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, ref, Suspense, Fragment, useSSRContext, createApp, shallowReactive, computed, unref, watch, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, getCurrentScope, toRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { l as parseURL$1, m as encodePath$1, n as decodePath, o as hasProtocol, q as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, r as getContext, $ as $fetch, f as createError$1, v as executeAsync, x as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "ajar-visual",
    path: "/ajar-visual",
    component: () => import('./ajar-visual-C75kJloV.mjs')
  },
  {
    name: "insurance-mobile",
    path: "/insurance-mobile",
    component: () => import('./insurance-mobile-5Vm7y_dM.mjs')
  },
  {
    name: "insurance-web",
    path: "/insurance-web",
    component: () => import('./insurance-web-Dx2_TYqN.mjs')
  },
  {
    name: "sync-board",
    path: "/sync-board",
    component: () => import('./sync-board-kILbFUdq.mjs')
  },
  {
    name: "tenant-master",
    path: "/tenant-master",
    component: () => import('./tenant-master-CwHBg_Ca.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BSHgKpqg.mjs')
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen text-[var(--color-text)] selection:bg-primary selection:text-white transition-colors duration-500 bg-[var(--color-bg)]" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bq9p0i_3.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-NWoL9qO0.mjs'));
...
export { __nuxt_component_0 as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, useRoute as u };
