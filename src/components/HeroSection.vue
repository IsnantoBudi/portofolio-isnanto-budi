  ...
  >
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
      <div class="space-y-6">
        ...
        <h1
          class="font-display text-6xl md:text-8xl font-black tracking-tight leading-none animate-fade-in-up animation-delay-100"
          style="letter-spacing: -0.03em;"
        >
          <span class="block text-[var(--color-text)]">{{ portfolioData.name.split(' ')[0] }}</span>
          <span class="block bg-gradient-to-r from-[var(--color-accent-primary)] via-[var(--color-accent-secondary)] to-[var(--color-accent-primary)] bg-[length:200%_auto] bg-clip-text text-transparent shimmer-btn">
