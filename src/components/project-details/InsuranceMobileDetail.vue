    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-20 text-center space-y-6">
        ...
        <h1 class="text-4xl md:text-6xl font-bold text-[var(--color-text)] tracking-tight leading-tight max-w-4xl mx-auto">
          ...
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-accent-primary)] to-[var(--color-accent-secondary)]">Klien & Agen dalam Genggaman</span>
        </h1>
      ...
      <div class="mb-24 rounded-3xl bg-gradient-to-br from-[var(--color-surface)] to-[var(--color-bg)] border border-[var(--color-border)] p-8 md:p-12 shadow-2xl overflow-hidden relative">
        ...
        <div class="relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div class="w-full lg:w-1/2 space-y-6">
            <h3 class="text-3xl font-bold text-[var(--color-text)]">User Experience Kelas Enterprise</h3>
      ...
      <div class="mb-24">
        <h2 class="text-3xl font-bold text-[var(--color-text)] mb-10 text-center">Fitur & Layanan Aplikasi</h2>
